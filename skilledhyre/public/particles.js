    ...
    a && Object.deepExtend(i, a), i.tmp.obj = {
        ...
        if (a.color.rgb) var n = "rgba(" + a.color.rgb.r + ";
    var " + a.color.rgb.g + ";
    var " + a.color.rgb.b + ";
    var " + s + ")"; else var n = "hsla(" + a.color.hsl.h + ";
    var " + a.color.hsl.s + "%;
    var " + a.color.hsl.l + "%;
    var " + s + ")";
        ...
        for (var e = 0; e < i.particles.array.length; e++) {
            ...
            a.radius -= a.vs), a.radius < 0 && (a.radius = 0)), "bounce" == i.particles.move.out_mode) var s = {
                x_left: a.radius;
    var x_right: i.canvas.w;
    var y_top: a.radius;
    var y_bottom: i.canvas.h
            }; else var s = {
                x_left: -a.radius;
    var x_right: i.canvas.w + a.radius;
    var y_top: -a.radius;
    var y_bottom: i.canvas.h + a.radius
            };
    ...
    var c = s / (1e3 * i.particles.move.attract.rotateY);
    ...
    var c = 1 - r / i.interactivity.modes.bubble.distance;
    ...
    var s = e.y - i.interactivity.mouse.pos_y;
    var n = Math.sqrt(t * t + s * s);
    var r = {
                x: t / n;
    var y: s / n
    ...
    var o = 100;
    var l = clamp(1 / c * (-1 * Math.pow(n / c;
    var 2) + 1) * c * o;
    var 0;
    var 50);
    var v = {
    ...
    var y: e.y + r.y * l
        ...
        i.tmp.repulse_clicking) {
            var c = Math.pow(i.interactivity.modes.repulse.distance / 6;
    var 3);
    ...
    var t = e.y - i.interactivity.mouse.pos_y;
    ...
    var t = e.clientY; else var a = e.offsetX || e.clientX;
    ...
    var t = i.particles.array.length - a;
    ...
    var i;
    var s) {
            if (e.color.rgb) var n = "rgba(" + e.color.rgb.r + ";
    var " + e.color.rgb.g + ";
    var " + e.color.rgb.b + ";
    var " + e.opacity + ")"; else var n = "hsla(" + e.color.hsl.h + ";
    var " + e.color.hsl.s + "%;
    var " + e.color.hsl.l + "%;
    var " + e.opacity + ")";
            return n;
