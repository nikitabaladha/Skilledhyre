    ...
    <>
      <div className="d-flex position-relative">
        <div className="position-relative">
          <div className="container-fluid mirror-image bottom-mirror-image">
            ...
            <Container fluid className="seo-bottom-row position-relative">
              <Row>
                <Col
                  md={6}
            ...
            {/* <div className="onum-particles" id="particles-50456bd8">
        <canvas
