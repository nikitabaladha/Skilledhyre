...
import AnalysisOfSecurity1 from "../../../../images/ServicesSubPageImages/AnalysisOfSecurity-1.jpg";
        ...
        <div className="container-fluid portfolio-sec">
          <div className="row">
            <div className="col-md-3">
              ...
              <h6 className="title-bottom">May 15, 2018</h6>
            </div>
            <div className="col-md-3">
              <h6 className="title-top">Category</h6>
              <h6 className="title-bottom">Marketing / Optimization</h6>
            </div>
            <div className="col-md-3">
...
export default AnalysisOfSecurity;
